...
export const skillsSection = {
	...
	data: [
		...
		{
			title: "Data Science",
			lottieAnimationFile: "/lottie/skills/data.json", // Path of Lottie Animation JSON File
			skills: [
				emoji("⚡ Experience of working on multiple cloud platforms"),
				emoji(
					"⚡ Hosting and maintaining websites on virtual machine instances along with integration of databases"
		...
		},
		{
			...
			lottieAnimationFile: "/lottie/skills/machine.json", // Path of Lottie Animation JSON File
			skills: [
				emoji("⚡ Experience of working on multiple cloud platforms"),
				emoji(
					"⚡ Hosting and maintaining websites on virtual machine instances along with integration of databases"
		...
		},
		{
			...
			lottieAnimationFile: "/lottie/skills/network.json", // Path of Lottie Animation JSON File
			skills: [
				emoji(
